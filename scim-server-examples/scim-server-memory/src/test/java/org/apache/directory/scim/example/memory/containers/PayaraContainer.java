...
public class PayaraContainer extends GenericContainer<PayaraContainer> implements WebAppContainer<PayaraContainer> {

  public PayaraContainer(String baseImage, Path warFile, Duration startupTimeout) {
    super(baseImage);
    this.withExposedPorts(8080)
      ...
      .waitingFor(Wait.forLogMessage(".*Payara Micro URLs.*", 1)
